...
class PBKDF2 {
    ...
    public static function createHash($password)
    {
        ...
        return self::PBKDF2_HASH_ALGORITHM . ":" . self::PBKDF2_ITERATIONS . ":" .  $salt . ":" . 
            base64_encode(self::generate_pbkdf2_hash(
    ...
    /**
     * Tarkistaa vastaako selväkielinen salasana annettuun tiivisteeseen
     * 
     * @param string $password
     ...
     */
    private static function generate_pbkdf2_hash($algorithm, $password, $salt, $count, $key_length, $raw_output = false)
    {
